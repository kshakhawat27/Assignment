...
(function ($) {
    ...
    $.fn.extend({
        ...
        PurchaseEditableTable: function (options) {
            ...
            $.fn.PurchaseEditableTable = function (method) {
            ...
            *************************************************************************/
            ...
            function _addrecordIntable(_newRow, _text, _columntype, i, field) {
                ...
                if (_columntype.type == 'textbox') {
                    ...
                    if (temp[0] != "ReadOnly" || temp[0] != "ReadOnlyText") {

                        if (_columntype.check != "sumationColumn")
                            input = $('<input class="add" style="width:' + _columntype.width + '" type="text"' + (_text != 'undefined' ? 'value="' + _text + '"' : '') + ' name="' + _text + '"></input>');

                        else if (temp[0] == "ReadOnlyText") {
                            input = $('<input class="someColumn" style="width:' + _columntype.width + '" type="text"' + (temp[1] != 'undefined' ? 'value="' + temp[1] + '"' : '') + ' name="' + temp[1] + '"></input>');
                            $(input).attr('readonly', true);
                        }

                        else
                            input = $('<input class="someColumn" style="width:' + _columntype.width + '" type="text"' + (_text != 'undefined' ? 'value="' + _text + '"' : '') + ' name="' + _text + '"></input>');
            ...
            function getselectedRowWisSumation() {
